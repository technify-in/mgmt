...
class adoDBPager extends ADODB_Pager
{
  var $links;
  var $getString;
  var $tableid = "pagertable";
  var $srnoenabled = true;

  function RenderGrid()
  {
    global $gSQLBlockRows; // used by rs2html to indicate how many rows to display
    require_once(_ABS_APPLICATION_PATH.'lib/eventRStohtml.inc.php');
    ...
    $this->gridAttributes,$this->gridHeader,$this->htmlSpecialChars, true, $this->tableid, $this->srnoenabled, $this->rows, $this->curr_page);
    $s = ob_get_contents();
    ob_end_clean();
    return $s;
  }

   function RenderLayout($header,$grid,$footer,$attributes='width="100%" border="0"')
   {
