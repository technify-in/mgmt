...
function userrs2html(&$rs, $links, $ztabhtml=false, $zheaderarray=false, $htmlspecialchars=true, $echo = true, $tableid)
{
  ...
  /*if (! $ztabhtml)*/ $ztabhtml = "BORDER='1' WIDTH='100%'".($tableid?" id='$tableid' class='tablesorter'":" class='aodb_table'");
  //else $docnt = true;
  $typearr = array();
  ...
  for ($i=1; $i < $ncols; $i++)
  {
    ...
    if(!$skip)
    {
      ...
      $hdr .= "<TH class='aodb_table_th'>$fname</TH>";
    }
  }
  //add special columns
  if($links)
